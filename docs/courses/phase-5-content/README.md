...
1. [01-block-1-fundamentos.md](01-block-1-fundamentos.md) — `COURSE-P5-01` — Fundamentos de NLP
2. [02-block-2-mlp.md](02-block-2-mlp.md) — `COURSE-P5-02` — El Perceptrón Multicapa
3. [03-block-3-rnn.md](03-block-3-rnn.md) — `COURSE-P5-03` — Redes Neuronales Recurrentes
4. [04-block-4-atencion.md](04-block-4-atencion.md) — `COURSE-P5-04` — El Puente hacia la Atención
5. [05-block-5-transformer.md](05-block-5-transformer.md) — `COURSE-P5-05` — El Transformer

**Order:** 00 first, then blocks in syllabus order. Block 1 can start as soon as P1 lands
